<nav id="menu_content">
    ...
    <footer>
        <!-- <h3 class="txt-gold">PARTENAIRES</h3>
        <div class="partenaires">
            <img src="<?php /* echo get_template_directory_uri() */ ?>/img/partenaires_magnificat.png" alt="">
            <img src="<?php /* echo get_template_directory_uri() */ ?>/img/partenaires_aleteia.png" alt="">
        </div> -->
    </footer>
</nav>